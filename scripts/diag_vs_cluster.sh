...
#
# Usage:
#   sbatch clusterAnalysis/scripts/diag_vs_cluster.sh
#   sbatch --export=CONFIG=my_config.yaml,RUN_NAME=exp01 clusterAnalysis/scripts/diag_vs_cluster.sh
#
...
# ── Parameters ────────────────────────────────────────────────────────────────
CONFIG="${CONFIG:-clusterAnalysis/configs/diag_vs_cluster.yaml}"
